return {
    ...
    susie_punch = function(cutscene, battler, enemy)
        ...
        cutscene:text("* Susie threw a punch at the dummy.")
        ...
        -- Susie text
        cutscene:text(
            "* You,[wait:5] uh,[wait:5] look like a weenie.[wait:5]\n"..
            "* I don't like beating up people like that.",
            "nervous_side", "susie"
        )
