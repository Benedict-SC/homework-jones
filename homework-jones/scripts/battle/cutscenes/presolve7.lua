return {
    ...
    presolve7 = function(cutscene,battler,enemy)
        ...
        cutscene:text("* ...what's a Solo model,[wait:5] anyway?","small_smile");
        enemy.sprite:setAnimation("lecture");
        cutscene:battlerText(enemy,"Don't worry about it!");
        enemy.sprite:setAnimation("idle");
        cutscene:text("* Is it like...[wait:5] you know,[wait:3] the crap with triangles?","nervous")
        enemy:shake(4);
        enemy.sprite:setAnimation("lecture");
        cutscene:battlerText(enemy,"Don't worry about it!!!");
        cutscene:text("* ...","sus_nervous")
        cutscene:setSpeaker("ralsei");
        cutscene:text("* I believe it's about economics,[wait:5] Susie.","surprise_smile")
        cutscene:setSpeaker("susie");
        cutscene:text("* So...[wait:5] money?","surprise");
